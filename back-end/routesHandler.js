...
const routesHandler = express() // instantiate an Express object
...
routesHandler.use(express.json()) // decode JSON-formatted incoming POST data
routesHandler.use(express.urlencoded({ extended: true })) // decode url-encoded incoming POST data
...
routesHandler.post('/portfolio', async (req, res) => {
  try {
...
routesHandler.get('/buy', async (req, res) => {
...
/* routesHandler.post('/buy', async (req, res) => {
  try{
...
routesHandler.get('/sell', async (req, res) => {        
  try {
...
/* 
routesHandler.post('/sell', async (req, res) => {
  try{
...
routesHandler.get('/coinTable', async (req, res) => {
...
/* routesHandler.post('/coinTable', async (req, res) => {
...
routesHandler.get('/compare', async (req, res) => {
  try {
     axios
...
routesHandler.get("/", (req, res) => {
 ...
 routesHandler.use(bodyParser.urlencoded({extended: false}));
 routesHandler.use(bodyParser.json());
//app.use(cors())
